...
const SUPABASE_URL = process.env.VITE_SUPABASE_URL || 'https://pnuolzmfajxwpofbbxbo.supabase.co';
const SUPABASE_KEY = process.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBudW9sem1mYWp4d3BvZmJieGJvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDkwNDM1ODUsImV4cCI6MjA2NDYxOTU4NX0.qa-noNI-MGjYdHNYD04orbUZygvpERaOsihp0P4D5ag';
...
const server = http.createServer((req, res) => {
  ...
  // Serve the waitlist page for all other routes
        ...
        <div class="max-w-2xl mx-auto text-center">
            ...
            <div class="mt-12 grid md:grid-cols-3 gap-6">
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <h3 class="text-lg font-semibent text-white mb-2">Exclusive Community</h3>
...
server.listen(PORT, '0.0.0.0', () => {
  console.log('Standalone waitlist server running on port ' + PORT);
});